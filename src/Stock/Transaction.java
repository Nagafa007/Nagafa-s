...
public class Transaction { // this class represents the StockOrder needed only when a user makes an order
	...
	public void markTransactionApproved() {
		this.transactionApproved = true; // mark transaction ass approved
	}
	...
	public String toString() {
		...
		String statusCode = (transactionApproved) ? "Approved" : "Rejected";
		return "Transaction { " + "transactionId = " + transactionId + ", Transactiontime = " + Transactiontime
				+ ", type = " + operation + ", amount = " + amount + ", userID = '" + userID + '\'' + ", statusCode = "
				+ statusCode
